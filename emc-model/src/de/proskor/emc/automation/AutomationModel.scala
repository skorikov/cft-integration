...
class AutomationModel(var objects: Set[Element]) extends AbstractModel {
  private val allTypes = Set[String]("Element", "Package", "Repository")
  private val concreteTypes = Set[String]("Package", "Element")
