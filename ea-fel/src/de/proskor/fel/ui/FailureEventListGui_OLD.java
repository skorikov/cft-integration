...
public class FailureEventListGui_OLD extends Shell {
	 ...
	 */
	public FailureEventListGui_OLD(GuiHandler guiListener, boolean readonly) {
	 ...
	 * @wbp.parser.constructor
	 */
	public FailureEventListGui_OLD(GuiHandler guiListener, boolean readonly, Display display) {
